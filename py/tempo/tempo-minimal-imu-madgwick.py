...
imu.setAccelRange("AccelRangeSelect4G")
...
import zmq
#--------zmq related------
xsub_addr = 'tcp://192.168.0.110:5556'
context = zmq.Context()
...
class Fetch(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            sensorData=[imu.AccelVals[0], imu.AccelVals[1], imu.AccelVals[2],sensorfusion.roll, sensorfusion.pitch, sensorfusion.yaw]
